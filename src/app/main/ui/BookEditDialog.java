...
import app.main.controller.SystemController;
...
public class BookEditDialog {
    ...
    public void setBook(Book book) {
        ...
        txtMaxCheckout.setText(Integer.toString(thisBook.getMaxCheckoutLength()));
    }
    ...
    private void handleOk() {
        if (isInputValid()) {
            ...
            thisBook.setMaxCheckoutLength(Integer.valueOf(txtMaxCheckout.getText()));
